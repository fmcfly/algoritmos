<%@page import="mx.upiicsa.virologia.modelos.InfoDes"%>
...
<% 
	...
	if(sesion.getAttribute("infoDes")!=null){
		...
		cifradoDES = ((infoDes.getCadenaEncriptada() ==null) ? "" : infoDes.getCadenaEncriptada());
		descifradaAES = ((infoDes.getCadenaDesencriptada() ==null) ? "" : infoDes.getCadenaDesencriptada());
	}
%>
<!DOCTYPE html>
<html>
...
<body>
	...
	<h1>DES</h1>
    <div class="container">
        <form class="row mb-2"  action="DEServlet" method = "POST"
        autocomplete="off">
            <div class="col-sm-4">
